   ...
   return (
      <>
         <div className="relative">
            <img src={img} className="md:w-[313px] w-full md:h-[169px]" alt="" />
            <div className="absolute bottom-0 flex items-center justify-between w-full">
               ...
               <Button onClick={onClick} name={'view'} classNames={'border-[0.5px] !text-[11px] font-semibold m-3 flex items-center py-[6px] px-[20px]  border-white rounded-full'} />
            </div>
         </div>
      </>
   );
