...
import { CreateMarketplaceAd, GetMarketplaceCategories } from '../../api/marketplace.service';
   ...
   return (
      <>
         <form className="" onSubmit={handleSubmit(onSubmit)}>
            <div className="p-6 px-10  bg-white rounded-t-[16px] max-sm:w-[350px]  md:w-[540px]">
               <h3 className="font-bold flex mt-2 mb-5 justify-center text-[16px] text-[#1F2937]">Post Ad</h3>
               ...
               <div className="mt-5 space-y-5 mb-9">
                  <div className="grid grid-cols-2 gap-2">
                     <div className="flex flex-col gap-[4px]">
                        <label className="font-semibold text-[11px] text-[#1F2937]">Ad Name</label>
                        <input type="text" placeholder="Ad Name" className=" text-[11px] w-full py-[10px] px-[13px] rounded-full border border-gray-300 focus:outline-none focus:border-gray-400" {...register('ad_name', { required: true })} />
                        {errors.ad_name && <span className="text-red-500 text-[11px]">This field is required</span>}
                     </div>
                  ...
                  <div className="flex flex-col gap-[4px]">
                     <label className="font-semibold text-[11px] text-[#1F2937]">Ad Pricing</label>
                     <input type="text" placeholder="Amount in GHS" className="text-[11px] py-[10px] px-[13px] rounded-full border border-gray-300 focus:outline-none focus:border-gray-400" {...register('ad_pricing', { required: true })} />
                     {errors.ad_pricing && <span className="text-red-500 text-[11px]">This field is required</span>}
                  </div>

                  <div className="grid grid-cols-2 gap-2">
                     <div className="flex flex-col gap-[4px]">
                        <label className="font-semibold text-[11px] text-[#1F2937]">Location</label>
                        <input type="text" placeholder="Ad Description" className="w-full text-[11px] rounded-full py-[10px] px-[13px] border border-gray-300 focus:outline-none focus:border-gray-400" {...register('location', { required: true })} />
                  ...
                  <div className="flex flex-col gap-[4px]">
                     <label className="font-semibold text-[11px] text-[#1F2937]">Description</label>
                     <input type="text" placeholder="Ad Description" className="w-full text-[11px] rounded-full py-[10px] px-[13px] border border-gray-300 focus:outline-none focus:border-gray-400" {...register('description', { required: true })} />
