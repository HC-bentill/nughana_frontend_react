          ...
          <div className="flex-1">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <h3 className="text-[14px] shorten-text max-w-[150px] font-semibold text-[#1A314D]">
                  {ad?.data?.acf?.ad_name}
                </h3>
              </div>
              <Button
            ...
            <div
              ...
              style={{ backgroundImage: `url(${ad?.data?.acf?.ad_image})` }}
            >
            ...
            <div className="grid grid-cols-3 gap-5 mt-5">
              <div className="col-span-2">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="font-extrabold shorten-text max-w-[250px] text-[18px]">
                    {ad?.data?.acf?.ad_name}
                  </h3>
                  <h3 className="font-extrabold text-[18px] text-[#AF7E00]">
                    GHS {ad?.data?.acf?.ad_pricing}
                  </h3>
                </div>
              ...
              <div className="p-4 bg-white rounded-[15px]">
                ...
                <div className="flex items-center mb-4">
                  <img
                    className="w-[18px] mr-4 h-[18px]"
                    src={location}
                    alt=""
                  />
                  <h3 className="text-[#171725] text-[12px]">
                    {ad?.data?.acf?.location}
                  </h3>
                </div>
                <div className="flex items-center mb-4">
