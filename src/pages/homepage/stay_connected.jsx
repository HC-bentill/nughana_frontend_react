      ...
      <section>
        <div className="flex justify-center">
          <div className="bg-[#101010] w-full text-white text-center md:py-20 md:px-20 px-4 py-20">
            <div className="flex justify-center">
              <h3 className="text-[29px] md:text-5xl">Stay connected with the African <span className="md:hidden" >Culture</span></h3>
            </div>
            <div className="flex justify-center md:mr-60 md:-mt-0 -mt-[47px]">
              <Underline className="md:w-56 w-[200px]" />
            </div>

            <h3 className="text-[29px] md:block hidden md:text-5xl mb-7">culture</h3>
