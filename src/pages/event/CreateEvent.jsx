...
function CreateEvent({ cancelModal }) {
      ...
      <>
         <form className="w-[540px] max-sm:w-[350px] !text-[11px]" onSubmit={handleSubmit(onSubmit)}>
            <div className="p-8 space-y-5 bg-white rounded-t-[16px]">
               ...
               <div className="grid grid-cols-2 gap-2 max-sm:grid-cols-1">
                  <div className="flex flex-col gap-[4px]">
                     <label className="font-semibold text-[11px] text-[#1F2937]">Event Name</label>
                     <input type="text" placeholder="Event Name" {...register('event_name', { required: true })} className="w-full max-sm:w-full text-[11px] h-[39px] py-[10px] px-[13px] rounded-full border border-gray-300 focus:outline-none focus:border-gray-400" />
                     {errors.event_name && <span className="text-red-500 text-[11px]">This field is required</span>}
                  </div>
               ...
               <div className="flex flex-col mt-2">
                  ...
                  <input type="text" placeholder="Group Description" {...register('description', { required: true })} className="w-full max-sm:w-full text-[11px] rounded-full h-[39px] py-[10px] px-[13px] border border-gray-300 focus:outline-none focus:border-gray-400" />
               ...
               <div className="grid grid-cols-2 gap-4 mt-8 max-sm:grid-cols-1">
                  <div className="max-sm:w-full">
                     <label className="mb-4 font-semibold text-[11px] text-[#1F2937]">Event Date</label>
                     <Flatpickr
                        className="bg-gray-50 mr-2 cursor-pointer border outline-0 border-gray-300 text-gray-900 text-[11px] rounded-lg block w-full !pl-5 !p-[10px] "
                  ...
                  <div className="flex flex-col">
                     <label className="font-semibold text-[11px] text-[#1F2937]">Event Location</label>
                     <input type="text" placeholder="Location" {...register('event_location', { required: true })} className="w-full max-sm:w-full text-[11px] h-[39px] py-[1px] px-[16px] rounded-full border border-gray-300 focus:outline-none focus:border-gray-400" />
            ...
            <div className="flex max-sm:justify-center  justify-end w-full bg-[#E5E7EB] rounded-b-[16px] p-3">
               ...
               <Button type={'submit'} classNames="text-white text-[11px] h-[38px] py-[6px] px-[36px] bg-black w-[114px]" name={'Post'} isLoading={loading} />
            </div>
         </form>
      </>
   );
