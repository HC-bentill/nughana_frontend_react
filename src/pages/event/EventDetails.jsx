            ...
            <div className="md:ml-3">
               ...
               <div className="max-sm:hidden flex justify-center text-center mt-9 py-8 w-[973px] h-[190px]">
                  <div className="relative">
                     <img src={adBanner} className="border-[7px] border-white rounded-[15px] " alt="" />
               ...
               <div className="flex flex-col py-8 ml-2 md:hidden">
                  <div className="relative">
                     <img src={adBanner} className="border-[7px] object-fill h-[149px] w-[400px] border-white rounded-[15px] " alt="" />
                     <div className="bg-[#FEF9C3] px-3 py-1 rounded-full absolute flex items-center left-3 top-3">
                        <img className="w-1 h-1 mr-2" src={g_bullet} alt="bullet" />
                        <small className="text-[#EAB308]">Electronics</small>
                     </div>
               ...
               <div className="grid grid-cols-3 gap-3 mx-4 mt-16 max-sm:grid-cols-1">
                  <div className="md:col-span-2 w-[617px]">
                     <div className="flex max-sm:flex-col md:items-center text-[22px] justify-between mb-6">
                        ...
                        <h3 className="font-extrabold  text-[#AF7E00]">{moment(eventData && eventData.acf.event_date, 'YYYYMMDD').format('Do MMMM YYYY')}</h3>
                     </div>
                  ...
                  <div>
                     <div className="p-8 bg-white rounded-[15px]">
                        <h3 className="text-[#171725] text-[14px] font-medium">Ad Created by</h3>
                        <div className="flex my-3">
                           <img src={adProfile} className="mr-3 w-[42px] h-[42px]" alt="" />
                           <div>
                              <h3 className="text-[#171725] text-[14px]">Kacy Mark Bartlett (you)</h3>
                              <small className="text-[#92929D] text-[12px]">12 April at 09:28 PM</small>
                           </div>
                        </div>
                        <div className="flex items-center">
               ...
               <div className="grid grid-cols-3 gap-4 mx-3 max-sm:flex max-sm:overflow-y-scroll">
                  {dashboardFeaturedEvents?.map((df, i) => (
                     <FeaturedEventCard otherClassNames={'w-[312px]'} key={i} img={df.img} footerImgs={df.footerImgs} footerIconsWith={'w-[24px] mr-2'} header={df.name} desc={df.desc} eventfooterDesc={'700+ members'} />
                  ))}
               </div>
            </div>
            <Messages />
