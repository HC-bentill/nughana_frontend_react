      ...
      <>
         <form className="" onSubmit={handleSubmit(onSubmit)}>
            <div className="p-8 bg-white">
               <h3 className="font-bold flex mt-2 mb-8 justify-center text-[18px] text-[#1F2937]">Create a Community</h3>
               <div className="flex justify-center mb-8">
                  <img src={avatar} className="w-[62px] h-[62px]" />
               </div>
               <div className="flex justify-center mb-5">
                  <Button classNames={'font-semibold !rounded-[10px] text-[10px] bg-gray-400 text-white'} name={'Change Community Image'} />
               </div>
               <div className="grid grid-cols-2 max-sm:flex-col">
                  <div className="flex flex-col mr-4">
                     <label className="font-semibold text-[11px] text-[#1F2937]">Community Name</label>
                     <input type="text" placeholder="Community Name" {...register('name', { required: true })} className="w-full max-sm:w-[370px] text-[11px] h-[39px] py-[10px] px-[13px] rounded-full border border-gray-300 focus:outline-none focus:border-gray-400" />
                  ...
                  <div className="flex flex-col w-full max-sm:mt-3">
                     ...
                     <select {...register('category', { required: true })} className="text-[11px] w-full py-[10px] px-[13px] rounded-full border border-gray-300 focus:outline-none focus:border-gray-400">
               ...
               <div className="flex flex-col mt-8">
                  <label className="font-semibold text-[11px] text-[#1F2937]">About Community</label>
                  <input type="text" placeholder="Community Description" {...register('description', { required: true })} className="w-full text-[12px] rounded-full h-[39px] py-[3px] px-[13px] border border-gray-300 focus:outline-none focus:border-gray-400" />
